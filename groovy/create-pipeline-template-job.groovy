...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/sitzm-ci-workshop/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>sitzm-ci-workshop</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>sitzm-ci-workshop</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/sitzm-ci-workshop/pipeline-template-catalog.git</repositoryUrl>
              <traits>
